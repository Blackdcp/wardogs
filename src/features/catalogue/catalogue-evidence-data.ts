...
export const seasonOneChanges: readonly SeasonOneChange[] = [
  ...
  {id: "artillery-tank-career-unlock", entity: "Artillery Tank career unlock", field: "Career unlock", previousValue: "$400,000", currentValue: "$500,000", effectiveBuild: "Season 1", verifiedAt: seasonOneVerifiedAt, sourceUrl: seasonOneSourceUrl, progressionTrack: "career"},
  {id: "artillery-tank-career-level", entity: "Artillery Tank required career level", field: "Required career level", previousValue: "55", currentValue: "90", effectiveBuild: "Season 1", verifiedAt: seasonOneVerifiedAt, sourceUrl: seasonOneSourceUrl, progressionTrack: "career"},
