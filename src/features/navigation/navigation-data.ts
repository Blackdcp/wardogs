  ...
  return [
    ...
    },
    {
      ...
      items: [
        ...
        {href: "/items/medical", label: t("nav.medical"), searchType: "item"},
        {href: "/items/supplies", label: t("nav.supplies"), searchType: "item"},
        {href: "/items/deployables", label: t("nav.deployables"), searchType: "item"},
