...
const topics: Record<VideoArticle["slug"], Partial<Record<TranslatedLocale, string>>> = {
  ...
  "wardogs-artillery-tank-guide": {ru: "наведение SPH-2, стабилизацию, экипаж, перезарядку и снабжение артиллерии", de: "SPH-2-Zielen, Stabilisierung, Besatzung, Nachladen und Artillerieversorgung", "pt-br": "mira da SPH-2, estabilização, tripulação, recarga e suprimento de artilharia", ja: "SPH-2の照準、安定化、乗員、リロード、砲兵補給"},
  "wardogs-ammo-types-tested": {ru: "выбор между FMJ, бронебойными и экспансивными боеприпасами против разной брони", de: "die Wahl zwischen FMJ, panzerbrechender und Weichzielmunition gegen verschiedene Rüstung", "pt-br": "a escolha entre FMJ, munição perfurante e munição para alvos sem blindagem", ja: "FMJ、徹甲弾、軟目標弾と装甲に応じた選択"},
  "wardogs-stingray-anti-vehicle-drone": {ru: "применение дрона Stingray против ценной техники и защиту оператора", de: "den Einsatz der Stingray-Drohne gegen wertvolle Fahrzeuge und den Schutz des Bedieners", "pt-br": "o uso do drone Stingray contra veículos valiosos e a proteção do operador", ja: "Stingray対車両ドローンの目標選びと操縦者防護"},
  "wardogs-fast-money-routes": {ru: "стабильный заработок через пилотирование, логистику, мобильную точку появления и медика", de: "verlässliches Einkommen durch Piloten-, Logistik-, Spawn- und Sanitäteraufgaben", "pt-br": "renda consistente com pilotagem, logística, ponto móvel e trabalho médico", ja: "操縦、兵站、移動スポーン、衛生兵による安定した資金稼ぎ"},
  "wardogs-vehicle-cargo-logistics": {ru: "грузовой интерфейс, Ural, ящики, поддоны и доставку ресурсов в FOB", de: "Frachtmenü, Ural, Kisten, Paletten und die Ressourcenlieferung zur FOB", "pt-br": "interface de carga, Ural, caixas, paletes e entrega de recursos ao FOB", ja: "貨物画面、Ural、クレート、パレット、FOBへの資材配送"},
  "wardogs-havoc-helicopter-guide": {ru: "MI-28 Havoc максимального уровня, контрмеры, выбор целей и противодействие ПВО", de: "den maximalen MI-28 Havoc, Gegenmaßnahmen, Zielwahl und Flugabwehr", "pt-br": "o MI-28 Havoc no nível máximo, contramedidas, alvos e defesa antiaérea", ja: "最大レベルMI-28 Havoc、対抗手段、目標選び、対空攻撃"},
  "wardogs-deadliest-sniper-guide": {ru: "снайперскую позицию, дальномер, выбор целей, боеприпасы и смену точки", de: "Scharfschützenposition, Entfernungsmesser, Zielwahl, Munition und Stellungswechsel", "pt-br": "posição de sniper, telêmetro, seleção de alvos, munição e reposicionamento", ja: "狙撃位置、距離計、目標選び、弾薬、射撃後の移動"},
  "wardogs-medic-mp9-loadout": {ru: "комплект Medic с MP9, безопасные revives, мобильность, позицию и денежный риск", de: "das Medic-MP9-Loadout, sichere Revives, Mobilität, Position und Geldrisiko", "pt-br": "o kit de Medic com MP9, revives seguros, mobilidade, posição e risco financeiro", ja: "MedicのMP9装備、安全な蘇生、機動力、位置、資金リスク"},
  "wardogs-huge-news-progression": {ru: "изменения прогресса, перенос танков и новости запуска", de: "Fortschrittsänderungen, den Panzerwechsel und Launch-Meldungen", "pt-br": "mudanças de progressão, a nova rota dos tanques e notícias do lançamento", ja: "進行変更、戦車の移動、発売ニュース"},
  "wardogs-support-skill-leveling": {ru: "прокачку Support через логистику, транспорт, ремонт и помощь команде", de: "Support-Fortschritt durch Logistik, Transport, Reparatur und Teamhilfe", "pt-br": "progressão de Suporte com logística, transporte, reparo e ajuda à equipe", ja: "兵站、輸送、修理、支援によるSupport進行"},
  "wardogs-kamikaze-drone-guide": {ru: "дрон-камикадзе, выбор цели, безопасный запуск и противодействие", de: "Kamikaze-Drohnen, Zielwahl, sicheren Start und Gegenmaßnahmen", "pt-br": "drone kamikaze, escolha de alvo, lançamento seguro e contrajogo", ja: "自爆ドローンの目標選び、安全な発射、対抗策"},
  "wardogs-gameplay-overview-tomographic": {ru: "комбинированные бои, три команды, транспорт, цели и поддержку", de: "Combined-Arms-Kämpfe, drei Teams, Fahrzeuge, Ziele und Support", "pt-br": "combate combinado, três equipes, veículos, objetivos e suporte", ja: "諸兵科連合、3チーム、車両、目標、支援"}
};
