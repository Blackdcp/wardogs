...
type AtlasDefinition = Omit<OperationsAtlasRecord, "evidence">;
...
const definitions: readonly AtlasDefinition[] = [
  {
    ...
    visual: {state: "contextual", image: "/images/catalogue/banners/map-1280.webp"},
  },
  {
    id: "tower-terminal",
    tasks: ["objective"],
  ...
  },
  {
    ...
    relatedToolHrefs: ["/tools/logistics-planner"],
    sourceLabel: "Official WARDOGS Steam description",
    visual: {state: "contextual", image: "/images/guide-discovery/equipment-tools.webp"},
  },
  {
    id: "cargo-route",
    tasks: ["logistics"],
    ...
    visual: {state: "contextual", image: "/images/catalogue/vehicles/ural.webp"},
  },
  {
    id: "mortar-support",
    tasks: ["fire-support"],
    ...
    visual: {state: "verified", image: "/images/catalogue/vehicles/l81-mortar.webp"},
  },
  {
    ...
    visual: {state: "contextual", image: "/images/wardogs-helicopter.jpg"},
  },
];
...
export const operationsAtlasRecords: readonly OperationsAtlasRecord[] = definitions.map((definition) => {
  ...
  return {...definition, evidence: record.evidence};
});
...
const sharedEntries = {
  "battlefield-control-zone": {title: "Battlefield and Control Zone"},
  "tower-terminal": {title: "Tower Terminal"},
  "oil-rig-hot-zone": {title: "Oil Rig / Drill Rig"},
  "fob-network": {title: "FOB Network"},
  "cargo-route": {title: "Cargo Route"},
  "mortar-support": {title: "Mortar Support"},
  "helicopter-transport": {title: "Helicopter Transport"},
} as const;

const copyByLocale: Record<Locale, OperationsAtlasCopy> = {
  en: {
    metaTitle: "WARDOGS Operations Atlas: Maps, FOBs, Cargo and Objectives",
    metaDescription: "Use the sourced WARDOGS operations atlas to move from Control Zone orientation to tower objectives, FOB construction, cargo, mortars, and helicopter transport without invented coordinates.",
