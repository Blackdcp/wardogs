  ...
  it("publishes every new guide in all five supported locales", async () => {
    for (const locale of locales) {
      for (const slug of newGuideSlugs) {
        ...
        expect(["2026-08-22", "2026-08-23", "2026-08-24", "2026-08-25", "2026-08-26", "2026-08-28", "2026-08-29", "2026-09-01", "2026-09-04", "2026-09-17"], `${locale}/${slug}`).toContain(guide?.frontmatter.updatedAt);
